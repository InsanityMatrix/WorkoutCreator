...
class Exercise {
  ...
  Exercise(
      this.name, this.primaryMuscle, this.secondaryMuscles, this.equipment);
  Map<String, dynamic> toJson() => {
        'Name': name,
  ...
  String subtitle() {
    String st = "Primary Muscle: " +
        getMuscleName(this.primaryMuscle) +
        "| Secondary Muscles: ";
    if (this.secondaryMuscles == null) {
      st += "none";
    } else {
...
Exercise SHRUGS =
    new Exercise("Shrugs", TRAPEZIUS, null, ["dumbbell", "barbell"]);
// ignore: non_constant_identifier_names
Exercise FARMERS_WALK = new Exercise("Farmers Walk", TRAPEZIUS,
    [DELTOIDS, ABS, OBLIQUES, CALVES], ["dumbbell", "barbell"]);
// ignore: non_constant_identifier_names
Exercise BENCHPRESS = new Exercise(
    "Benchpress", CHEST, [DELTOIDS, TRICEPS, ABS], ["barbell", "dumbbell"]);
// ignore: non_constant_identifier_names
Exercise SHOULDER_PRESS = new Exercise("Shoulder Press", DELTOIDS,
    [TRAPEZIUS, TRICEPS, ABS], ["barbell", "dumbbell"]);
// ignore: non_constant_identifier_names
Exercise DIPS = new Exercise(
    "Dips", TRICEPS, [CHEST, DELTOIDS, RHOMBOIDS], ["dipbars", "calisthenics"]);
Exercise CONCENTRATION_CURLS =
    new Exercise("Concentration Curls", BICEPS, null, ["dumbbell"]);
Exercise BENT_OVER_BARBELL_ROW = new Exercise("Bent over barbell row", DELTOIDS,
    [TRAPEZIUS, LATS, RHOMBOIDS, BICEPS], ["barbell"]);
Exercise DUMBBELL_PULLOVERS =
    new Exercise("Dumbbell Pullovers", LATS, [CHEST, TRICEPS], ["dumbbells"]);
Exercise INCLINE_BENCHPRESS =
    new Exercise("Incline Benchpress", CHEST, [DELTOIDS, TRICEPS], ["barbell"]);
Exercise INCLINE_DUMBBELL_PRESS = new Exercise(
    "Incline Dumbbell Press", CHEST, [DELTOIDS, TRICEPS], ["dumbbell"]);
Exercise FACE_PULLS =
    new Exercise("Face Pulls", DELTOIDS, [RHOMBOIDS, TRAPEZIUS], ["cable"]);
Exercise LATERAL_RAISES =
    new Exercise("Lateral Raises", DELTOIDS, [TRAPEZIUS], ["dumbbell"]);
Exercise PULLUPS = new Exercise("Pullups", LATS, [TRAPEZIUS, RHOMBOIDS, BICEPS],
    ["pullupbar", "calisthenics"]);
Exercise CHINUPS = new Exercise("Chinups", BICEPS, [
  LATS,
  DELTOIDS,
], [
  "pullupbar",
...
Exercise LAT_PULLDOWNS =
    new Exercise("Lat Pulldowns", LATS, [RHOMBOIDS, TRAPEZIUS], ["cable"]);
Exercise REAR_DELT_FLY = new Exercise("Rear Delt Fly", DELTOIDS,
    [TRAPEZIUS, RHOMBOIDS], ["flymachine", "dumbbell"]);
Exercise ARNOLD_PRESS =
    new Exercise("Arnold Press", DELTOIDS, [TRICEPS], ["dumbbell"]);
Exercise W_Raise = new Exercise("W-Raise", DELTOIDS, [TRAPEZIUS], ["dumbbell"]);
Exercise TRICEP_KICKBACK =
    new Exercise("Tricep Kickback", TRICEPS, null, ["dumbbell"]);
Exercise SKULL_CRUSHERS =
    new Exercise("Skullcrushers", TRICEPS, null, ["barbell", "dumbbell"]);
Exercise HAMMER_CURL = new Exercise("Hammer Curls", BICEPS, null, ["dumbbell"]);
Exercise INCLINE_DUMBBELL_CURL =
    new Exercise("Incline Dumbbell Curl", BICEPS, null, ["dumbbell"]);
Exercise SPIDER_CURLS =
    new Exercise("Spider Curls", BICEPS, null, ["dumbbell"]);
Exercise CHEST_FLY =
    new Exercise("Chest Fly", CHEST, [DELTOIDS], ["flymachine", "dumbbell"]);
Exercise PRONE_LATERAL_RAISE =
    new Exercise("Prone Lateral Raise", RHOMBOIDS, null, ["dumbbell"]);
Exercise BENT_OVER_DUMBELL_ROW = new Exercise("Bent Over Dumbell Row",
    RHOMBOIDS, [DELTOIDS, TRAPEZIUS, LATS], ["dumbbell"]);
Exercise SQUEEZE_PRESS =
    new Exercise("Squeeze Press", CHEST, [TRICEPS], ["dumbbell"]);
Exercise PLATE_PRESS =
    new Exercise("Plate Press", CHEST, [TRICEPS], ["barbell"]);
Exercise PUSHUPS = new Exercise("Pushups", CHEST, [TRICEPS], ["calisthenics"]);
Exercise FRONT_RAISE =
    new Exercise("Front Raise", DELTOIDS, null, ["dumbbell"]);
Exercise TRICEP_PUSHDOWNS =
    new Exercise("Tricep Pushdowns", TRICEPS, null, ["cable"]);
Exercise DUMBBELL_CURL =
    new Exercise("Dumbbell Curl", BICEPS, null, ["dumbbell"]);
Exercise BARBELL_CURL = new Exercise("Barbell Curl", BICEPS, null, ["barbell"]);
//Lower Body
Exercise DEADLIFT = new Exercise(
    "Deadlift", GLUTES, [QUADS, LATS, TRAPEZIUS], ["barbell", "dumbbell"]);
Exercise ROMANIAN_DEADLIFT = new Exercise(
    "Romanian Deadlifts", HAMSTRINGS, [GLUTES, QUADS], ["barbell", "dumbbell"]);
Exercise BACK_SQUAT =
    new Exercise("Back Squat", GLUTES, [HAMSTRINGS, QUADS], ["barbell"]);
Exercise FRONT_SQUAT =
    new Exercise("Front Squat", QUADS, [ABS, GLUTES, HAMSTRINGS], ["barbell"]);
Exercise GOBLET_SQUAT = new Exercise(
    "Goblet Squat", QUADS, [CALVES, GLUTES, ABS, HAMSTRINGS], ["dumbbell"]);
Exercise HIP_THRUSTS = new Exercise("Hip Thrust", GLUTES, null, ["barbell"]);
Exercise BULGARIAN_SPLIT_SQUATS = new Exercise("Bulgarian Split Squats", QUADS,
    [GLUTES, HAMSTRINGS, CALVES], ["dumbbell", "barbell"]);
Exercise SINGLE_LEG_DEADLIFT =
    new Exercise("Single Leg Deadlift", GLUTES, [QUADS], ["dumbbell"]);
Exercise LUNGES =
    new Exercise("Dumbbell Lunges", QUADS, [GLUTES, HAMSTRINGS], ["dumbbell"]);
Exercise LATERAL_LUNGES = new Exercise(
    "Lateral Lunge", GLUTES, [QUADS], ["dumbbell", "calisthenics"]);
Exercise LEG_CURL =
    new Exercise("Leg Curl", HAMSTRINGS, [CALVES], ["legmachine"]);
Exercise LEG_EXTENSIONS =
    new Exercise("Leg Extensions", QUADS, null, ["legmachine"]);

Exercise STANDING_CALF_RAISE = new Exercise("Standing Calf Raise", CALVES, null,
    ["barbell", "dumbbell", "calisthenics"]);
Exercise SEATED_CALF_RAISE =
    new Exercise("Seated Calf Raise", CALVES, null, ["dumbbell"]);
//Core
Exercise RUSSIAN_TWISTS =
    new Exercise("Russian Twists", OBLIQUES, [ABS], ["calisthenics"]);
...
Exercise REVERSE_CRUNCH =
    new Exercise("Reverse Crunch", ABS, null, ["calisthenics"]);
...
Exercise INVERTED_SHRUGS =
    new Exercise("Inverted Shrugs", TRAPEZIUS, [], ["calisthenics"]);
Exercise HANGING_LEG_LIFTS =
...
Workout createWorkout(
    String name, int epm, List<int> selectedMuscles, Config config) {
